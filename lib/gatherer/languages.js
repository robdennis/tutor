...
(function() {
  ...
  module.exports = function(details, callback) {
    ...
    fetch(1, details, $$(function(html) {
      ...
      max = pagination(cheerio.load(html)('#ctl00_ctl00_ctl00_MainContent_SubContent_SubContent_languageList_pagingControls')).max;
      if (max === 1) {
  ...
  extract = function(html) {
    var $;
    $ = cheerio.load(html);
    return _.map($('tr.cardItem'), function(el) {
      var $name, code, id, language, name, trans_card_name, _ref;
      _ref = $(el).children(), trans_card_name = _ref[0], language = _ref[1];
  ...
  merge = function(results) {
    var code, id, name, o, _i, _len, _ref;
    o = {};
